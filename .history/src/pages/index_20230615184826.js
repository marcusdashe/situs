...
"
              ...
              <div className=" flex items-center self-start mt-2">
                <Link
                  ...
                  target={"_blank"}
                  className="flex items-center bg-primaryDark text-white p-2.5 mx-6 rounded-lg text-lg font-semibold hover:bg-light hover:text-primaryDark duration-500 border border-solid border-transparent hover:border-primaryDark"
                >
                  Resume
                </Link>
                <Link
