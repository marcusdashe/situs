      ...
      <div ref={ref} className="w-[80%] mx-auto relative">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            ...
            time="2020-Present"
            address="Elijah House, 3 Abbey Street, Bwari District, Abuja, Nigeria"
          ...
          <Details
            ...
            companyLink="#"
            company="Hossanah Cyber Cafe"
            time="2016-2017"
            address="Funnah House Opposite Access Bank Bukuru, Jos Plateau State"
            work="As a computer operator, my role encompasses various responsibilities to ensure smooth operations. These include proficiently handling typesetting tasks, delivering efficient internet services, 
                        managing printing processes, facilitating online registrations, and providing valuable training to students."
          />
        </ul>
      </div>
    </div>
